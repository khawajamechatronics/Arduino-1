...
// pins definition
//#define AT_DEVICE_ON_PIN              8 // connect GSM Module turn ON to pin 77 
//#define AT_DEVICE_RESET_PIN           9 // connect GSM Module RESET to pin 35
...
class AT {
	public:
		enum AT_st_e { ERROR, IDLE, READY, ATTACHED, TCPSERVERWAIT, TCPCONNECTEDSERVER, TCPCONNECTEDCLIENT };
...
public:
     ...
     rx_state_enum IsRxFinished(void);
