...
void setup()
{
  ...
  if(result == 1)
  {
    ...
    googleDns.init(/*"google.co.il"*/"david-henry.dyndns.tv", buffer);  //Buffer contains the IP address of the DNS server
    googleDns.resolve();
    ...
    Serial.print("david-henry.dyndns.tv IP address: ");
    printArray(&Serial, ".", buffer, 4, 10);
