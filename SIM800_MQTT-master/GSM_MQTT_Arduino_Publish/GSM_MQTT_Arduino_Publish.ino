...
String APN = "xxxxxxxxxx";   // replace with your SIM's APN
...
*/
/*
   Hardware reset for the modem.
   On my TinyOS SIM900 board I have to toggle pin 8 as below.
   Modify for you own circumstances
*/
#define RESET_PIN 8
void GSM_MQTT::Reset()
{
