...
*/
/*
 *   David Henry GitHub mgaman
 *   APN string (see AT+CSTT) declared in the main *.ino file
 *   begin modified to allow modem reset if no reply to "AT\r"
 */
#include "GSM_MQTT.h"
#include "Arduino.h"
...
//              _sendAT("AT+CSTT=\"AIRTELGPRS.COM\"\r\n", 5000);
              String cstt = "AT+CSTT=\"" + APN + "\"\r\n";
              _sendAT(const_cast<char*>(cstt.c_str()),5000);
              break;
            }
          case 3:
            {
