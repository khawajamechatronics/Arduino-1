...
// What page to grab!
//#define WEBSITE      "david_henry.dyndns.tv"
#define WEBSITE      "david_henry.dyndns.tv"
#define SERVER_IP              10, 0, 0, 8    // Logging server IP address.  Note commas
#define WEBSITE_TCP_PORT 8000
...
void setup(void)
{
  ...
  */
  Adafruit_CC3000_Client www = cc3000.connectTCP(ip, WEBSITE_TCP_PORT);
  sprintf(bigbuff,"<C I=\"%u\" T=\"GUP\" />",ID);
  if (www.connected()) {
    www.print(bigbuff);
  }
  else 
